...
const copter_validator_1 = require("../common/dto/copter.validator");
let ConsultoraMutualController = class ConsultoraMutualController {
    ...
    async login(body) {
        console.log(...oo_oo(`2560162697_30_4_30_24_4`, 'login'));
        try {
            return {
    ...
    async cashOut(body, req) {
        console.log(...oo_oo(`2560162697_45_4_45_27_4`, 'cash-out'));
    ...
    async getCustomerByAlias(alias, req) {
        console.log(...oo_oo(`2560162697_61_4_61_47_4`, 'get-customer-by-alias/:alias'));
        const token = req.query.token;
        try {
            return {
                statusCode: common_1.HttpStatus.ACCEPTED,
            ...
            console.log(...oo_oo(`2560162697_73_6_73_24_4`, error));
            throw new common_1.HttpException(error?.message, common_1.HttpStatus.BAD_REQUEST);
        }
    }
    async getCustomerByCbu(cbu, req) {
        console.log(...oo_oo(`2560162697_81_4_81_43_4`, 'get-customer-by-cbu/:cbu'));
        const token = req.query.token;
        try {
            return {
                statusCode: common_1.HttpStatus.ACCEPTED,
            ...
            console.log(...oo_oo(`2560162697_90_6_90_24_4`, error));
            throw new common_1.HttpException(error?.message, common_1.HttpStatus.BAD_REQUEST);
        }
    }
    async loginExchange(res) {
        console.log(...oo_oo(`2560162697_98_4_98_33_4`, 'login-exchange'));
        await this.consultoraMutualService
            ...
            res.status(common_1.HttpStatus.ACCEPTED).send(response);
        })
            .catch((error) => {
            console.log(...oo_oo(`2560162697_110_8_110_26_4`, error));
            const response = {
                statusCode: common_1.HttpStatus.BAD_REQUEST,
                message: 'Error login-exchange',
                data: error,
            };
            res.status(common_1.HttpStatus.BAD_REQUEST).send(response);
        });
    }
    async transactionExchange(body, res) {
        console.log(...oo_oo(`2560162697_125_4_125_41_4`, 'transferencia-exchange'));
        await this.consultoraMutualService
            ...
            .catch((error) => {
            console.log(...oo_oo(`2560162697_137_8_137_26_4`, error));
            const response = {
                statusCode: common_1.HttpStatus.BAD_REQUEST,
    ...
    async checkCBU(cbu, res) {
        console.log(...oo_oo(`2560162697_149_4_149_27_4`, 'checkCbu'));
        await this.consultoraMutualService
            .checkCBU(cbu)
            .then((result) => {
            const response = {
            ...
            .catch((error) => {
            console.log(...oo_oo(`2560162697_161_8_161_26_4`, error));
            const response = {
                statusCode: common_1.HttpStatus.BAD_REQUEST,
    ...
    async saldo(res) {
        console.log(...oo_oo(`2560162697_173_4_173_24_4`, 'saldo'));
        await this.consultoraMutualService
            .saldo()
            .then((result) => {
            const response = {
            ...
            .catch((error) => {
            console.log(...oo_oo(`2560162697_185_8_185_26_4`, error));
            const response = {
                statusCode: common_1.HttpStatus.BAD_REQUEST,
                message: 'Error saldo',
                data: error,
    ...
    async estadoTransaccion(id, res) {
        console.log(...oo_oo(`2560162697_197_4_197_37_4`, 'estado-transaccion'));
        await this.consultoraMutualService
            ...
            .catch((error) => {
            console.log(...oo_oo(`2560162697_209_8_209_26_4`, error));
            const response = {
                statusCode: common_1.HttpStatus.BAD_REQUEST,
...
__decorate([
    (0, common_1.Post)('login-exchange'),
    __param(0, (0, common_1.Res)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], ConsultoraMutualController.prototype, "loginExchange", null);
__decorate([
    (0, common_1.Post)('transferencia-exchange'),
    __param(0, (0, common_1.Body)()),
    __param(1, (0, common_1.Res)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [copter_validator_1.transferenciaCreditoDto, Object]),
    __metadata("design:returntype", Promise)
], ConsultoraMutualController.prototype, "transactionExchange", null);
__decorate([
    (0, common_1.Get)('checkCbu/:cbu'),
    __param(0, (0, common_1.Param)('cbu')),
    __param(1, (0, common_1.Res)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, Object]),
    __metadata("design:returntype", Promise)
], ConsultoraMutualController.prototype, "checkCBU", null);
__decorate([
    ...
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], ConsultoraMutualController.prototype, "saldo", null);
__decorate([
    (0, common_1.Get)('estado-transaccion/:id'),
    __param(0, (0, common_1.Param)('id')),
    __param(1, (0, common_1.Res)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, Object]),
    __metadata("design:returntype", Promise)
], ConsultoraMutualController.prototype, "estadoTransaccion", null);
